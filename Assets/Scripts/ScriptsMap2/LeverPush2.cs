...
public class LeverPush2 : MonoBehaviour
{
    ...
    private Vector3 initialLocalPosition = new Vector3(-7.55f, 1f, -2f);
    private Vector3 activatedLocalPosition = new Vector3(-7.23f, 1f, -2f);
